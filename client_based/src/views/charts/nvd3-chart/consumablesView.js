...
const GroupsView = () => {
    ...
    const fetchData = async  ()=>{
        try{
            const response = await PagesService.getPurchases(currentYear)
        ...
        <React.Fragment>
            <Row>
                    ...
                    <Card className="mt-2">
                        ...
                        <Collapse in={accordionKey === 1}>
                            <div id="accordion1">
                                <Card.Body>
                                    <Card.Text>
                                       Исходные ресурсы - программные продукты,
                                        человека-часы специалистов, техника и прочие активы,
                                        закупаемые и используемые в IT-стат для разработки программных и аппаратных продуктов.
                                    </Card.Text>
                                </Card.Body>
                            </div>
                        </Collapse>
                ...
                <Col sm={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Закупки исходных ресурсов</Card.Title>
                        </Card.Header>
                        <Card.Body>
                ...
                Значения закупок исходных ресурсов в таблице.
              </span>
                        </Card.Header>
                        <Card.Body>
                            <Table responsive hover>
                                <thead>
                                <tr>
                                    <th>Исходный ресурс</th>
                                    <th>Сумма закупок ресурса</th>
                                </tr>
                                </thead>
                                <tbody>
                                {
